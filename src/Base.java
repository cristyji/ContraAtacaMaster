...
public class Base {
    ...
    private boolean bVivo; // estado del objeto
     ...
     * @return boolean <code> true</code> si colisiona <code> false</code> si
     * no colisiona
     * 
     */
    public boolean colisiona(Object obj)
    {
        ...
        if(obj instanceof Base)
        {
            ...
            Rectangle recOtro = new Rectangle(((Base) obj).getX(), 
                    ((Base) obj).getY(), ((Base) obj).iAncho, ((Base) obj).iAlto);
     ...
     * setVivo
     * 
     * Metodo modificador usado para cambiar el estado del objeto 
     * 
     */
    public void setVivo(boolean bV) {
            this.bVivo = bV;
    }
     ...
     * getVivo
     * 
     * Metodo de acceso que regresa el estado del objeto
     * 
     * @return bVivo es el <code>estado</code> del objeto.
     * 
     */
